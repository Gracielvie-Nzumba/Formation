...
<body>
    ...
    <a href="http://localhost/php.treading/calculatrice/script.php" class="font-bold text-grey-700">Return<a/>
    <a href="http://localhost/php.treading/tauxdeChange/index.php" class="font-bold text-blue-600">Next<a/>
    </div>
